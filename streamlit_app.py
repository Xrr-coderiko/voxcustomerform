 ...
 with st.container(border=True):
  ...
  with cxxf1:
   ...
   with sex1: 
    ...
    with sex2:
       st.markdown(f"<div style='text-align: center; border: 1px solid lightGrey; border-radius: 5px;'><h5>Qualified Leads</h5><h6>{total_vn}</h6></div>", unsafe_allow_html=True)
