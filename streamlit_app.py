 ...
 with st.container(border=True):
  ...
  with cxxf1:
   ...
   with sex1: 
    if 'SENT BY' in existing_data.columns:
     ...
     total_row = pd.DataFrame([['TOTAL', totalcs,' ']], columns=['CC-EXECUTIVE', 'QUALIFIED','ATTENDED'])
  ...
  with cxxf2:
    ...
    with st.container(border=True): 
     ...
     ).properties(title="Requirement Summary", height=230, width=300)
