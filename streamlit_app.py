 ...
 with st.container(border=True):
  ...
  with cxxf1:
   ...
   with sex1: 
    ...
    with sex2:
       st.markdown(f"<div style='text-align: center; justify-content: center; width: 170px; height: 70px; border: 1px solid lightGrey; border-radius: px;'><h5>Qualified Leads<br>{total_vn}</h5></div>", unsafe_allow_html=True)
  ...
  with cxxf2:
    ...
    with st.container(border=True): 
     ...
     ).properties(title="Requirement Summary", height=250, width=300)
