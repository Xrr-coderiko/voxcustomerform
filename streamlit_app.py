 ...
 with st.container(border=True):
  ...
  with cxxf1:
   ...
   with sex1: 
    ...
    with sex2:
       st.markdown(f"<div style='text-align: center; width: 150px; height: 70px; border: 1px solid lightGrey; border-radius: 5px;'><h5>Qualified Leads<br>{total_vn}</h5></div>", unsafe_allow_html=True)
