...
with tab2:
 ...
 with st.container(border=True):
  ...
  with cxxf2:
    st.markdown(f"<div style='text-align: center; border: 2px solid Black; margin-bottom: 10px;'><h2>TOTAL LEADS: {total_vn}</h2></div>", unsafe_allow_html=True)
