 ...
 with st.container(border=True):
  ...
  with cxxf1:
   ...
   with sex1: 
    ...
    with sex2:
       st.markdown(f"<div style='text-align: center; width: 150px; height: 100px; border: 1px solid Grey; border-radius: 10px;'><h5>Qualified Leads</5><h6>{total_vn}</h6></div>", unsafe_allow_html=True)
